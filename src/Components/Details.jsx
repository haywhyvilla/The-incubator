...
const Details = () => {
  return (
    <section>
      <div class="md:px-[140px] grid grid-cols-3 gap-2 sm:gap-14 sm:ml-0 ml-6">
        <div>
          <div class="w-full border-b-2 border-[#333333] py-2 mb-2 sm:pr-0 pr-3">
          ...
          <div class="sm:flex justify-center items-center gap-6 my-8 border-[#EEEEEE] border-b-[1px] py-2 mb-2">
            ...
            <div>
              <h3 className="text-[#111111] font-['Jost'] font-medium text-sm mb-3">
                DJ Tunez and Amexin live the fast life on “Lambo”
              </h3>
          ...
          <div class="my-8 border-[#EEEEEE] border-b-[1px] py-2 mb-2">
            <h3 className="text-[#111111] font-['Jost'] font-medium text-sm mb-3">
              The Undeniable Force of Nigerian Street-Pop
            </h3>
            <p class="text-[#808080] font-['Work_Sans'] font-normal text-xs uppercase">
              January 11, 2023
            </p>
