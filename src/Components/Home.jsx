    ...
    >
      ...
      {open ? (
        <div>
          ...
          <div class="w-[500px] mt-[350px] sm:mt-0 sm:ml-8 pl-6 pr-20 sm:px-0 absolute md:relative bottom-2">
            ...
            <p class="font-['Work_Sans'] text-[#F5F5F5] font-normal text-base my-3 hidden sm:hidden">
              As someone who values loyalty above all else, he will not let
              himself get distracted by anything other than the job at hand.
              Well, right now, all eyes are Still on Divine. And...
            </p>
